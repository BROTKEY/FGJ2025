...
func _process(_delta: float) -> void:
	$IconsContainer/Pinecil.visible = InputManager.is_device_connected(InputManager.InputDevice.PINECIL)
	$IconsContainer/MidiKeyboard.visible = InputManager.is_device_connected(InputManager.InputDevice.MIDI_KEYBOARD)
	$IconsContainer/WiiBoard.visible = InputManager.is_device_connected(InputManager.InputDevice.WII_BOARD)
